...
from consolidate_markdown.attachments.document import MarkItDown, ConversionError
...
def test_csv_conversion(markdown_converter, fixtures_dir):
    ...
    df = pd.read_csv(csv_file, encoding="cp1252", engine="python")  # Use same params as converter
