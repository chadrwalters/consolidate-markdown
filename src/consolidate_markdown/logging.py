...
class SummaryLogger:
    ...
    def add_from_cache(self, source_type: str):
        """Record a file loaded from cache."""
    ...
    def _format_category_stats(self, name: str, total: int, generated: int, from_cache: int, skipped: int) -> list[str]:
    ...
    def get_summary(self) -> str:
        ...
        for source_type, stats in self.source_stats.items():
            ...
            # Notes
            lines.extend(self._format_category_stats(
                "Notes",
                stats['processed'],
                stats['generated'],
                stats['from_cache'],
            ...
            # GPT Analysis
            if stats['gpt_generated'] > 0 or stats['gpt_from_cache'] > 0 or stats['gpt_skipped'] > 0:
                lines.extend(self._format_category_stats(
                    "GPT Analysis",
        ...
        # GPT Analysis
        if self.stats['gpt_generated'] > 0 or self.stats['gpt_from_cache'] > 0 or self.stats['gpt_skipped'] > 0:
            lines.extend(self._format_category_stats(
                "GPT Analysis",
